...
public:
  CoveragePlannerNode() : Node("slic3r_coverage_planner")
  {
    ...
    plan_path_srv_ = this->create_service<slic3r_coverage_planner_msgs::srv::PlanPath>(
        "slic3r_coverage_planner/plan_path", std::bind(&CoveragePlannerNode::planPathCallback, this, _1, _2));

    RCLCPP_INFO(this->get_logger(), "Slic3r Coverage Planner initialized");
  }

private:
  void planPathCallback(const std::shared_ptr<slic3r_coverage_planner_msgs::srv::PlanPath::Request> request,
