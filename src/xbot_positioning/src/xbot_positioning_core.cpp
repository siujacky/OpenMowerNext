...
const xbot::positioning::StateT& xbot::positioning::xbot_positioning_core::updateOrientation(double theta,
                                                                                             double covariance)
{
...
const xbot::positioning::StateT& xbot::positioning::xbot_positioning_core::updateOrientation2(double vx, double vy,
                                                                                              double covariance)
{
  orient_m2.vx() = vx;
  orient_m2.vy() = vy;
...
const xbot::positioning::StateT& xbot::positioning::xbot_positioning_core::updateSpeed(double vx, double vr,
                                                                                       double covariance)
{
  speed_m.vx() = vx;
  speed_m.vr() = vr;
