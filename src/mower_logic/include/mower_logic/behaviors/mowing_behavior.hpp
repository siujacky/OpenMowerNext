...
public:
  ...
  {
    return current_mowing_area_;
  }
  int16_t get_current_path() const
  {
    return current_mowing_path_;
  }
  int16_t get_current_path_index() const
  {
    return current_mowing_path_index_;
  }
