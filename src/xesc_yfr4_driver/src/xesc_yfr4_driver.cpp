...
XescYFR4Driver::XescYFR4Driver(rclcpp::Node::SharedPtr node)
: node_(node)
{
  RCLCPP_INFO(node_->get_logger(), "Starting xesc YardForce R4 adapter driver");

  xesc_interface_ = std::make_unique<XescYFR4Interface>(
    std::bind(&XescYFR4Driver::errorCallback, this, std::placeholders::_1));
